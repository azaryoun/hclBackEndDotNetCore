...
namespace MicroService.Controllers
{
    ...
    public class ToDoStatusTypeController : Controller
    {

        public ToDoStatusTypeController()
        {
        ...
        public IActionResult getLookUps()
        {
            ...
            try
            {
                var oGetEntitiesTableAdapter = new DataAccess.lookUp.ToDoStatusTypeTableAdapters.GetToDoStatusTypesTableAdapter();
